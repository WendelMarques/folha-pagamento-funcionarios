...
public class Estagiario extends Programador{
	...
	public Estagiario(int matricula, String primeiro_nome, String ultimo_nome, double salarioB, int numeroProjetosConcluidosMes) {
	...
	public void gravaEstagiario () {
		...
		do {
			...
			try {
		   		bw = new BufferedWriter(new FileWriter("estagiarios.txt", true));
	 		...
	 		verificador = 0; //se ocorrer algum erro (usuario digita caracter no lugar de int, por exemplo) 
	 						//verificador recebe 1 e entao nao faz a gravacao parcial dos dados
	 		...
	 		try {
				...
				System.out.println("\n**************************************************************************************************************\n"
						+ "\t\t\t\t\tFOLHA DE PAGAMENTO\n\nPAGINA INICIAL > ADICIONAR ESTAGIARIO"
			     + "\n**************************************************************************************************************\n");
				...
				System.out.printf("%s", "Segundo nome:");
...
//				   buf = input.nextLine();
			...
			if(verificador == 0) {
				...
				System.out.printf("\n\n \t\t\t| Estagiario %s %s adicionado com sucesso!", pri_nome, ult_nome);
	...
	public void mostraCabecalho() {
		  System.out.println("\n**************************************************************************************************************\n"
					+ "\t\t\t\t\tFOLHA DE PAGAMENTO\n\nPAGINA INICIAL > LISTA DE ESTAGIARIOS"
		     + "\n**************************************************************************************************************\n");
	...
	public void mostraFuncionario() {
		  ...
		  try {
		     leitura_texto = new Scanner(new File("estagiarios.txt"));
			 mostraCabecalho();
	...
	public void calculaSalarioTotal(double salarioBase) {
	...
	public void calculaSalarioIndividual () {
		...
		this.calculaSalarioTotal(this.salarioBase);
